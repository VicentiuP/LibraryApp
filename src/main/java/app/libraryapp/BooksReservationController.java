...
public class BooksReservationController implements Initializable {
    ...
    private static BooksReservationController instance;
    public BooksReservationController(){
        instance = this;
    }
    public static BooksReservationController getInstance(){
        return instance;
    }

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        lb_page_title.setText("Books Reservation");
        lb_message.getText();
        ...
        if (selectedBook){
            ...
            if (stock != 0){
                ...
                if (alreadyLentOrReserved.isEmpty()){
                    DataSource.getInstance().addLentOrReservedBook(selectedBookId, customerId, firstName, lastName, "RESERVED");
                    lb_message.setText("Book reserved!");
                } else {
